node.exe : Warning: 256-color support not detected. Using a terminal with at least 256-color support is recommended for a better visual experience.
At C:\nvm4w\nodejs\gemini.ps1:16 char:5
+     & "$basedir/node$exe"  "$basedir/node_modules/@google/gemini-cli/ ...
+     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    + CategoryInfo          : NotSpecified: (Warning: 256-co...ual experience.:String) [], RemoteException
    + FullyQualifiedErrorId : NativeCommandError
 
Ripgrep is not available. Falling back to GrepTool.
Error when talking to Gemini API Full report available at: 
C:\Users\jltej\AppData\Local\Temp\gemini-client-error-Turn.run-sendMessageStream-2026-07-14T13-58-06-058Z.json TerminalQuotaError: You have exhausted your 
